...
import {
  LayoutDashboard, Clock, MapPin, PlusCircle,
  Users, Flag, Settings, LogOut, MessageSquare,
  Users2, Gift,
} from "lucide-react";
      ...
      <div className="asb-bottom">
        <div className="asb-profile">
          ...
          <div className="asb-profile-info">
            <div className="asb-profile-name">{user.first_name} {user.last_name}</div>
