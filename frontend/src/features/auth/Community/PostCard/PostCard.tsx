    ...
    <article className={`pc ${isHidden ? "pc--hidden" : ""}`}>
      ...
      <div className="pc-head">
        ...
        <div className="pc-head-info">
          ...
          <div className="pc-meta-row">
            ...
            {post.place && (
              <span className="pc-place"><MapPin size={10} /> {post.place.name}</span>
            )}
      ...
      {images.length > 0 && (
        <div className="pc-media">
          {images.length === 1 && (
            <img className="pc-img pc-img--single" src={imgUrl(images[0])} alt="" />
          )}
          {images.length === 2 && (
        ...
        >
          ...
          {showReacts && (
           <div
            ...
            >
              {reactKeys.map(type => (
                <button key={type} className="pc-react-btn" title={REACTS[type].label}
            ...
            <div className="pc-cmt-box">
              {replyTo && (
                <div className="pc-reply-banner">
                  <Reply size={11} />
                  Replying to <strong>{replyTo.user.first_name}</strong>
